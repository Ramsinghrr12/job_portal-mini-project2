...
//             <a href="https://facebook.com/dharavath Ramsingh" className="hover:text-gray-400" aria-label="Facebook">
...
//             </a>
//             <a href="https://twitter.com/ramsingh" className="hover:text-gray-400" aria-label="Twitter">
...
//             </a>
//             <a href="https://www.linkedin.com/in/ramsingh-dharavath-03bb771b5/" className="hover:text-gray-400" aria-label="LinkedIn">
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          ...
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-sm text-gray-600">© 2025 Job Hunt. All rights reserved.</p>
          </div>
          ...
          <div className="flex space-x-4">
            <a href="https://facebook.com/dharavathRamsingh" className="hover:text-gray-600" aria-label="Facebook">
              <svg className="w-6 h-6 text-blue-600 hover:text-blue-800" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22.676 0H1.324C.593 0 0 .592 0 1.324v21.352C0 23.408.593 24 1.324 24H12.82V14.706H9.692v-3.578h3.128V8.408c0-3.1 1.893-4.787 4.657-4.787 1.325 0 2.463.1 2.794.144v3.238l-1.918.001c-1.503 0-1.794.715-1.794 1.762v2.31h3.587l-.468 3.578h-3.119V24h6.116C23.407 24 24 23.408 24 22.676V1.324C24 .592 23.407 0 22.676 0z" />
              </svg>
            </a>
            <a href="https://twitter.com/ramsingh" className="hover:text-gray-600" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/ramsingh-dharavath-03bb771b5/" className="hover:text-gray-600" aria-label="LinkedIn">
        ...
        <div className="mt-6 text-center">
          <button
            ...
            className="px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition duration-300"
          >
            Back to Top ↑
          </button>
        </div>
